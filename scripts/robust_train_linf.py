...
from cords.utils.custom_dataset import load_dataset_custom, CustomAdvDataset, cifar10_mean, cifar10_std, clamp
...
class TrainRobustClassifier:
    ...
    def get_perturbations(self, model, dataloader, criterion, epsilon, alpha, attack_iters, delta_init, std, attack_type='pgd'):
        """
        This function is used to generate adversarial perturbations for the entire training dataset
        based on the current state of the model. These perturbations are required to perform adver-
        sarial coreset selection.
        """
            ...
            for batch_idx, (inputs, targets) in enumerate(dataloader):
                ...
                with torch.enable_grad():
                    ...
                    if delta_init == 'random':
                        ...
                        delta.data = clamp(delta, lower_limit - input_var, upper_limit - input_var)
    ...
    # Borrowed from Fast Adversarial Training Github repo: https://github.com/locuslab/fast_adversarial/blob/master/CIFAR10/utils.py
    ...
    def train(self):
        ...
        if self.configdata['train_args']['robust_train']:
            ...
            valadvloader           = torch.utils.data.DataLoader(validadvset, batch_size=val_batch_size, huffle=False, pin_memory=True)
