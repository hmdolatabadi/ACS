...
class CRAIGStrategy(DataSelectionStrategy):
    ...
    def __init__(self, trainloader, valloader, model, loss,
                 ...
                 selection_type, optimizer='lazy', beta=1.0):
        """
        Constructer method
        """
        super().__init__(trainloader, valloader, model, num_classes, linear_layer, loss, device, beta)
    ...
    def compute_score(self, model_params, idxs):
        ...
        if self.if_convex:
            # TODO: in our experiments we were only concerned with DNNs, so we didn't care about this part.
            ...
            for batch_idx, (inputs, inputs_adv, targets) in enumerate(subset_loader):
    ...
    def get_similarity_kernel(self):
        ...
        """
        for batch_idx, (_, _, targets) in enumerate(self.trainloader):
