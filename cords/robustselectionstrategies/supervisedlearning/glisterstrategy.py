...
class GLISTERStrategy(DataSelectionStrategy):
    ...
    def _update_grads_val(self, grads_currX=None, first_init=False):
        ...
        if first_init:
            for batch_idx, (inputs, inputs_adv, targets) in enumerate(self.valloader):
            ...
            # TODO: Since we will not be using GLISTER in our experiments, this part is skipped for now.
